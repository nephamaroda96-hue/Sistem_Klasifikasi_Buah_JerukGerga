...
st.markdown(f"""
<style>
    /* Memaksa Penggunaan Font Times New Roman di Seluruh Aplikasi */
    html, body, [data-testid="stAppViewContainer"], .stApp, p, span, label, li, h1, h2, h3, h4, h5, h6, input, button {{
    ...
    if img_src:
        ...
        <div style='background: #FFFFFF; 
            ...
            <div style='color: #555555; font-size: 13px; line-height: 1.4; font-family: "Times New Roman", Times, serif;'>
                Deteksi kualitas jeruk secara cepat, akurat, dan mudah.
            </div>
        </div>
        """, unsafe_allow_html=True)
...
# ==============================
    ...
    st.markdown("<p style='text-align:center; font-size:20px; color:#555555; margin-top:-15px; margin-bottom:30px;'>Pilih metode untuk mengambil atau mengunggah citra jeruk gerga secara real-time</p>", unsafe_allow_html=True)
    ...
    with col_berkas:
        ...
        # Mengatur agar status gambar yang masuk tetap tersimpan di session state sebelum di-submit
            ...
            with c2:
                if r['grade'] == "Bukan Jeruk":
                    ...
                    with metric_col:
                        ...
                        st.markdown("""
                        <div class='info-box'>
                            Nilai confidence adalah nilai untuk mengukur tingkat keyakinan model terhdap gambar yang diunggah semakin besar confidencenya maka model semakin yakin bahwa jeruk itu masuk ke kelas tersebut.
                        </div>
                        """, unsafe_allow_html=True)
...
Logit C (z3): {r['logits'][2]:.4f}
    ...
    <div class='custom-card'>
        ...
        <ul>
            <li><b>Bahasa Pemrograman & Tampilan: Menggunakan bahasa <i>Python</i> dan framework <i>Streamlit</i> untuk membuat halaman dashboard web yang mudah digunakan.</li>
            <li><b>Model Kecerdasan Buatan (AI): Menggunakan library <i>PyTorch</i> dengan model Vision Transformer (Swin Transformer) yang bertugas mengenali bentuk dan tekstur kulit jeruk dari foto.</li>
