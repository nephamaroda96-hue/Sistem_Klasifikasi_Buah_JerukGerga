...
# ==============================
# MODERN CSS UI ENHANCEMENT (FONT TIMES NEW ROMAN & ANTI-BERTUMPUK)
# ==============================
st.markdown(f"""
<style>
    /* 1. Paksa SEMUA elemen di aplikasi menggunakan Times New Roman */
    html, body, [data-testid="stAppViewContainer"], .stApp, button, input, select, textarea, p, div, span, li, h1, h2, h3, h4, h5, h6 {{
        font-family: 'Times New Roman', Times, serif !important;
    }}

    /* 2. Blokir & sembunyikan teks ikon bawaan Streamlit yang merusak tampilan */
    div[data-testid="stExpander"] button small,
    ...
    /* Sembunyikan substring teks ikon yang bocor keluar */
    span:contains("_arrow_right"), div:contains("_arrow_right"),
    span:contains("upload"), div:contains("upload") {{
        text-indent: -9999px;
        letter-spacing: -10px;
    }}
    ...
    /* Memperbesar & Set Font Tombol Menu di Sidebar */
...
# ==============================
# HALAMAN 3: PROCESSING (VALIDASI COCOK & AMAN)
# ==============================
    ...
    with center_box:
        # VALIDASI UTAMA: Jika list temporer gambar kosong, tampilkan info penolakan secara halus.
        if not st.session_state.temp_imgs:
        ...
        # Jika gambar sudah siap, baru jalankan proses deep learning
        else:
