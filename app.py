...
# ==============================
# CSS UI ENHANCEMENT (ANTI-BERTUMPUK PERMANEN)
# ==============================
st.markdown(f"""
<style>
    /* Ubah font ke Times New Roman HANYA pada text buatan kita dan container utama, tanpa menyentuh tombol bawaan */
    [data-testid="stAppViewContainer"], .main-title, .custom-card, .hero-banner, .info-box {{
        font-family: 'Times New Roman', Times, serif !important;
    }}
    
    .main-title, .custom-card h3, .custom-card h4, .custom-card p, .custom-card li, .hero-banner h1, .hero-banner p {{
        font-family: 'Times New Roman', Times, serif !important;
    }}
    ...
    /* Set Font Menu di Sidebar agar serasi menggunakan Times New Roman */
